  ...
  return (
    <>
      ...
      <section className="max-w-6xl mx-auto px-4 pb-8" aria-labelledby="turtle-seo">
        <h2 id="turtle-seo" className="font-black text-slate-900 dark:text-white mt-4">Loops that draw</h2>
        <p className="text-sm text-slate-600 dark:text-slate-300 mt-1">Move, turn &amp; repeat — create squares, stars &amp; spirals. Infinite canvas uses HTML5 Canvas and saves your last drawing to localStorage.</p>
      </section>
    </>
  );
}
