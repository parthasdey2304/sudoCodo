  ...
  return (
    <>
      ...
      <section className="max-w-6xl mx-auto px-4 pb-8" aria-labelledby="puzzle-seo">
        <h2 id="puzzle-seo" className="font-black text-slate-900 dark:text-white mt-4">Why start with Puzzle?</h2>
        <p className="text-sm text-slate-600 dark:text-slate-300 mt-1">Puzzle teaches that blocks have shapes — only matching notches and plugs connect. The first Blockly game shows syntax-free coding visually, perfect for ages 5+.</p>
      </section>
    </>
  );
}
