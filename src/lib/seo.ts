...
export const SEO: Record<string, PageSeo> = {
  ...
  maze: {
    title: "Maze Coding Game - Loops & Logic Puzzles | SudoCodo",
  ...
  sequencing: {
    title: "Sequencing Game - Order Code Like CodeMonkey | SudoCodo",
  ...
  bird: {
    title: "Bird Coding Game - Conditional Logic Fun | SudoCodo",
  ...
  turtle: {
    title: "Turtle Draw with Code - Loops & Geometry | SudoCodo",
  ...
  movie: {
    title: "Movie Animation Game - Code with Math | SudoCodo",
  ...
  music: {
    title: "Music Coding Game - Compose with Blocks | SudoCodo",
  ...
  pond: {
    title: "Pond Battle Game - Code Your Duck vs AI | SudoCodo",
